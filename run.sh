...
python train.py -i data/expanded_shalaka_logical_firefox_TRAIN.pkl -m models/mlaba_shalaka.pkl -v 
...
python train.py -i data/expanded_pratik_TRAIN.pkl -m models/mlaba_pratik.pkl -v
