...
python preprocess.py -i data/expanded_shalaka_logical_firefox.csv -f 10 -p 0.95
python train.py -i data/expanded_shalaka_logical_firefox_TRAIN.pkl -m models/mlaba_shalaka.pkl 
...
python preprocess.py -i data/expanded_pratik.csv -f 10 -p 0.95
python train.py -i data/expanded_pratik_TRAIN.pkl -m models/mlaba_pratik.pkl 
